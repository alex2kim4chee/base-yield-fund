...
export const translations: Record<'ru' | 'en', TranslationSchema> = {
  ru: {
    nav: {
      title: 'Base Yield Agent',
      subtitle: 'ИИ-ассистент для DeFi-транзакций с self-custody',
      verify: 'Проверить позиции',
      getAccess: 'Лист ожидания →',
      compoundPool: 'Демо-кошелек:',
    ...
    problem: {
      ...
      compareFund: 'Средняя ставка по выбору ИИ',
    ...
    whatWeDo: {
      ...
      step5Desc: 'Вы лично проверяете подготовленный черновик транзакции и подписываете ее через аппаратный ключ (passkey) с FaceID или TouchID.',
      step6Title: 'Запуск транзакции',
      step6Desc: 'После вашей подписи транзакция отправляется на блокчейн. Результат операции и доход отражаются напрямую в вашем кошельке.',
      custodyProof: 'Доказательство self-custody: вы лично подписываете каждую транзакцию на блокчейне. Base Yield Agent не имеет доступа к вашему балансу и не может совершать действия без вас.',
    },
    tech: {
    ...
    strategy: {
      ...
      title: 'Один кошелек. Шесть протоколов. DeFi-автоматизация в сети Base.',
      subline: 'Ассистент анализирует live-рынки. Вы можете распределить капитал между консервативными депозитами и активными пулами ликвидности на основе подготовленных ИИ рекомендаций.',
      table: {
    ...
    whoThisIsFor: {
      ...
      convictions: {
        ...
        c4Desc: 'Вам не нужно становиться экспертом в смарт-контрактах. Ассистент готовит готовые вызовы функций, а ключи остаются у вас.',
      },
      table: {
        title: 'Сравнение: Традиционные финансы vs Self-Custody Автоматизация',
        tradTitle: 'ТРАДИЦИОННЫЕ ФИНАНСЫ',
        fundTitle: 'ИИ-АССИСТЕНТ BASE YIELD AGENT',
        ...
        returnFund: 'Плавающие протокольные ставки от 4.0% до 40.0% APY',
    ...
    decisions: {
      ...
      title: 'Анализ данных. Подготовка ИИ. Подписание вами.',
      ...
      card: {
        ...
        hint: 'Агент готовит черновик транзакции и объяснение рисков. Пользователь самостоятельно решает, подписывать или отклонить действие.',
      },
    },
    ownership: {
      tagline: 'РАЗДЕЛ 08 — ВЛАДЕНИЕ АККАУНТОМ',
      title: 'Счет принадлежит вам. Агент только готовит транзакции.',
      subline: 'Это не общий пул и не управление средствами. Вы не передаете капитал третьим лицам. Ваши стейблкоины остаются на вашем личном смарт-кошельке (ERC-4337) под вашим полным контролем.',
      ...
      manage: 'ЧТО ГОТОВИТ АГЕНТ',
      manageItems: [
        'Ежедневный мониторинг лучших доходностей',
        'Подготовка транзакций с расчетом газа и рисков',
        'Логирование операций для вашей отчетности',
      ],
      card: {
        ...
        btn: 'Запросить доступ к ИИ-ассистенту →',
      },
    },
    faq: {
    ...
    liveHealth: {
      ...
      metrics: {
        ...
        tvlSub: 'Размер баланса в демонстрации',
        accounts: 'АКТИВНЫЕ ПОДКЛЮЧЕНИЯ ИИ',
        accountsSub: 'Количество симулируемых сессий',
        apy: 'СРЕДНЯЯ СТАВКА APY ДЕМО-СЧЕТА',
        apySub: 'Средняя ставка по протоколам в демо',
        txs: 'ПОДГОТОВЛЕННЫЕ ЧЕРНОВИКИ',
        txsSub: 'Доля одобренных транзакций',
      },
      feed: {
        title: 'Журнал активности ИИ-агента в реальном времени',
        subline: 'Пример работы: какие данные ИИ сканирует и какие действия предлагает для ручного подтверждения.',
        ...
        actions: {
          deposit: 'Подготовка депозита',
          rebalance: 'Анализ ребаланса',
          compound: 'Compound (аккумуляция)',
          withdraw: 'Подготовка вывода',
        },
        status: {
          confirmed: 'Одобрено (Executed)',
          pending: 'Черновик (Draft)',
        },
        times: {
          justNow: 'Только что',
    ...
    footer: {
      badge: 'ПОЛУЧИТЬ ДОСТУП К АГЕНТУ',
      title: 'Готовы оптимизировать ваши DeFi-транзакции?',
      ...
      disclaimer: 'Предупреждение: Base Yield Agent является исключительно программным обеспечением для автоматизации транзакций на кошельке пользователя и не оказывает кастодиальных или инвестиционных услуг. Продукт не является финансовым консультантом, брокером или инвестиционным фондом. Инвестиции в DeFi сопряжены с рисками смарт-контрактов, волатильности ставок и потери капитала. Прошлые результаты симуляций не гарантируют доход в будущем.',
      copyright: '© 2026 Base Yield Agent. Работает на технологиях абстракции кошельков Coinbase Smart Account и Anthropic Model Context Protocol. Все права защищены.',
    },
    modal: {
      close: '[esc] ЗАКРЫТЬ',
      badge: 'СВЯЗЬ И ДОСТУП',
      title: 'Связаться с Base Yield Agent',
      subline: 'Выберите цель вашего обращения для автоматической подготовки запроса.',
      accessTitle: 'Лист ожидания для доступа',
      accessDesc: 'Подать заявку на ранний доступ к ИИ-ассистенту. Пожалуйста, укажите в письме размер транзакционного баланса, готовый к размещению (минимальный порог симуляции от $1 000).',
    ...
    calculator: {
      ...
      desc: 'Настройте сумму симулируемого баланса и уровень риска для расчета потенциальных параметров доходности.',
      depositLabel: 'Симулируемый баланс',
      ...
      disclosure: {
        title: 'Оценка гипотетического сценария просадки',
      ...
      disclaimer: '*Симуляция доходности носит справочный характер и основывается на текущих ставках протоколов. Подготовка всех транзакций осуществляется ассистентом, но подписывается лично вашим passkey-ключом.',
    },
    simulator: {
      walletBadge: 'BASE SMART ACCOUNT',
      connected: 'Подключен',
      statusInactive: 'ИИ-сканер не запущен',
      descInactive: 'Запустите сканер в терминале справа для инициализации поиска оптимальных пулов.',
      btnScan: 'Запустить ИИ-сканирование',
      statusActive: 'ИИ-агент ищет пулы...',
      reading: 'Анализ текущих блоков сети...',
      rebalanceBadge: 'ПОДГОТОВЛЕН ЧЕРНОВИК РЕБАЛАНСИРОВКИ',
      ago: 'только что',
      fluidTitle: 'Доходность в пулах Fluid',
      deltaText: 'доходность выросла',
      rebalanceAction: 'Перераспределить 30% баланса из Morpho Prime в Fluid с избыточным обеспечением.',
      ...
      completeTitle: 'Транзакция успешно выполнена',
      completeDesc: 'Транзакция ребалансировки подтверждена. Обновленные DeFi-позиции отражены в журнале.',
      ...
      logs: {
        ...
        auth: 'USER-AUTH >> Запрос криптографической подписи от Coinbase Smart Account...',
        ...
        resolved: 'STG-TX >> Ребалансировка завершена. Журнал транзакций обновлен.',
    ...
    protocols: [
      ...
      },
      {
        ...
        badgeColor: 'bg-green-500/10 text-green-400 border-green-500/20',
        textColor: 'text-green-400',
        description: 'Интеграция с кураторскими хранилищами под управлением Gauntlet и Steakhouse Finance для выдачи займов под избыточный залог.'
      },
      {
    ...
    riskProfiles: {
      ...
      balanced: {
        ...
        description: 'Предлагает сплит стейблкоинов между надежными консервативными якорями и высоколиквидными Moonwell и Fluid.',
      ...
      growth: {
        ...
        description: 'Использует торговые комиссии бирж и ликвидность контрагентов для предложения максимальных ставок.',
    ...
    notDoPrinciples: [
      {
        ...
        desc: 'Агент никогда не готовит кредитные плечи или маржинальные позиции под залог ваших активов.'
      },
      {
  ...
  en: {
    nav: {
      title: 'Base Yield Agent',
      subtitle: 'AI-Assisted Self-Custody DeFi',
      verify: 'Verify Positions',
      getAccess: 'Get early access →',
      compoundPool: 'Demo Wallet:',
    ...
    problem: {
      ...
      compareFund: 'AI Selection Typical Rate',
    ...
    whatWeDo: {
      ...
      step5Desc: 'You review the prepared transaction draft and sign it locally using your secure hardware passkey (FaceID or TouchID).',
      step6Title: 'On-chain execution',
      step6Desc: 'Once signed, the transaction is broadcast to the Base network. Returns accrue directly in your self-custody wallet.',
      custodyProof: 'Self-custody proof: You physically sign every transaction on the blockchain. Base Yield Agent has zero access to your funds and cannot act without your signature.',
    },
    tech: {
    ...
    strategy: {
      ...
      title: 'One wallet. Six protocols. DeFi automation on Base.',
      subline: 'The assistant scans live markets. You can allocate capital across conservative deposits and active liquidity pools based on AI-prepared recommendations.',
      table: {
    ...
    whoThisIsFor: {
      ...
      convictions: {
        ...
        c4Desc: 'You do not need to become an active DeFi wizard. The assistant drafts secure transaction calls while you keep 100% custody keys.',
      },
      table: {
        title: 'Comparison: Traditional Finance vs Self-Custody Automation',
        tradTitle: 'TRADITIONAL FINANCE',
        fundTitle: 'BASE YIELD AGENT AI ASSISTANT',
        ...
        freezesFund: 'Decentralized censorship-resistant standard',
        ...
        returnFund: 'Variable protocol rates from 4.0% to 40.0% APY',
        identity: 'Identity:',
    ...
    decisions: {
      ...
      card: {
        ...
        hint: 'The agent prepares a transaction draft and risk assessment. The user independently decides whether to sign, edit, or reject.',
      },
    },
    ownership: {
      tagline: 'SECTION 08 — ACCOUNT OWNERSHIP',
      title: 'You keep your account. The agent only prepares transactions.',
      subline: 'This is not a pooled fund or discretionary account management. You never send funds to third parties. Your stablecoins stay situated inside your self-custody Smart Account (ERC-4337) under your absolute control.',
      ...
      manage: 'WHAT THE AGENT PREPARES',
      manageItems: [
        'Daily opportunity monitoring',
        'Transaction drafts with gas and risk assessments',
        'Operation logs formatted for your reporting',
      ],
      card: {
        ...
        btn: 'Request access to the AI assistant →',
      },
    },
    faq: {
    ...
    liveHealth: {
      ...
      metrics: {
        ...
        tvlSub: 'Simulation balance size',
        accounts: 'ACTIVE AI CONNECTIONS',
        accountsSub: 'Number of simulated sessions',
        apy: 'DEMO BLENDED APY RATE',
        apySub: 'Typical protocol rates in demo',
        txs: 'PREPARED TRANSACTION DRAFTS',
        txsSub: 'User approval success rate',
      },
      feed: {
        title: 'Real-Time AI Agent Activity Log',
        subline: 'How the agent scans live indexes and constructs transaction drafts for manual confirmation.',
        ...
        actions: {
          deposit: 'Prepare Deposit',
          rebalance: 'Analyze Rebalance',
          compound: 'Compound (Accrual)',
          withdraw: 'Prepare Withdraw',
        },
        status: {
          confirmed: 'Approved (Executed)',
    ...
    footer: {
      badge: 'JOIN THE INVITE LIST',
      title: 'Ready to optimize your DeFi transactions?',
      subline: "Early access is limited to invited accounts. If you received this link from someone you trust, you're already in.",
      cta: 'Request access →',
      disclaimer: 'Base Yield Agent is strictly a software automation tool for executing actions on the user\'s wallet. It does not provide custodial, brokerage, or discretionary investment services. The platform is not a financial adviser or investment fund. Cryptocurrency activities carry risks of smart contract failure, protocol rate volatility, and capital loss. Past simulation results do not guarantee future performance.',
      copyright: '© 2026 Base Yield Agent. Powered by Coinbase Smart Account and Anthropic Model Context Protocol. All rights reserved.',
    },
    modal: {
      close: '[esc] CLOSE',
      badge: 'CONTACT & ACCESS',
      title: 'Contact Base Yield Agent',
      subline: 'Select the purpose of your request to automatically prepare a secure email template.',
      accessTitle: 'Access Waitlist',
      accessDesc: 'Apply for early access to the AI software. Please specify your planned simulation balance in the email template (minimum entry limit is $1,000).',
    ...
    calculator: {
      ...
      desc: 'Adjust your simulated balance and appetite parameters to calculate potential yield metrics.',
      depositLabel: 'Simulated Balance',
      ...
      disclosure: {
        title: 'Hypothetical Downside Scenario Analysis',
      ...
      weightTitle: 'Asset Allocation Weight',
      disclaimer: '*Yield estimates are for informational purposes only. The assistant drafts all transactions, but they are signed manually with your secure hardware passkey.',
    },
    simulator: {
      walletBadge: 'BASE SMART ACCOUNT',
      connected: 'Connected',
      statusInactive: 'AI Scanner Inactive',
      descInactive: 'Click the scan trigger in the terminal to launch the real-time AI scanner.',
      btnScan: 'Trigger Live OCR Scan',
      statusActive: 'AI Agent Scanning',
      reading: 'Reading on-chain live blocks...',
      rebalanceBadge: 'REBALANCE DRAFT PREPARED',
      ago: 'ago',
      fluidTitle: 'Fluid USDC Lending Yield',
      deltaText: 'delta',
      rebalanceAction: 'Rebalance 30% of the simulated balance from Morpho Prime into Fluid vaults.',
      ...
      completeTitle: 'Transaction Completed',
      completeDesc: 'The rebalance transaction has been successfully confirmed. Updated positions are shown in the ledger.',
      ...
      logs: {
        ...
        resolved: 'STG-TX >> Rebalance completed. Transaction ledger updated.',
    ...
    protocols: [
      ...
      },
      {
        ...
        badgeColor: 'bg-green-500/10 text-green-400 border-green-500/20',
        textColor: 'text-green-400',
        description: 'Integrates with curated lending vaults managed by Gauntlet and Steakhouse Finance. Lends to institutional borrowers against overcollateralized assets.'
      },
      {
        id: 'morpho-high-yield',
        name: 'Morpho (High Yield Vaults)',
    ...
    riskProfiles: {
      ...
      balanced: {
        ...
        description: 'Focuses on higher average yields by suggesting stablecoin allocation splits between conservative anchors and high-liquidity lending hubs like Moonwell and Fluid.',
        expectedApyRange: [7.0, 9.5],
        allocations: [
      ...
      growth: {
        ...
        description: 'Leverages market fees from stablecoin LP pools, trading counterparties, and dynamic volume pools to target elevated variable rates.',
        expectedApyRange: [11.0, 25.0],
        allocations: [
    ...
    notDoPrinciples: [
      {
        ...
        desc: 'The agent never prepares borrowing actions or leverage setups.'
      },
      {
        title: 'No Meme Tokens & Hype Contracts',
        desc: 'The assistant strictly interacts with established stablecoin-denominated smart vaults with clean histories.'
      },
      {
