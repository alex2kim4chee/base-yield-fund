...
export const EVENTS = [
  ...
  {
    dateRu: '23 июл 2026', dateEn: 'Jul 23, 2026',
    nameRu: 'HY v1.1 APY: повторная инверсия ниже Prime', nameEn: 'HY v1.1 APY: inverts below prime tier again',
    descRu: '4.77% → 3.63% — второй раз за 2 недели ниже Gauntlet Prime (4.27%); TVL $2.63M',
    descEn: '4.77% → 3.63% — second time in 2 weeks below Gauntlet Prime (4.27%); TVL $2.63M',
    pnlBase: 0, type: 'neg' as const,
  },
  {
    dateRu: '22–23 июл 2026', dateEn: 'Jul 22–23, 2026',
    nameRu: 'Morpho Prime: yield (1 день)', nameEn: 'Morpho Prime: yield (1 day)',
  ...
  },
  {
    dateRu: '22–23 июл 2026', dateEn: 'Jul 22–23, 2026',
    nameRu: 'HY v1.1: yield (1 день)', nameEn: 'HY v1.1: yield (1 day)',
    descRu: '$49 335 × 1 день @ ~3.63% APY — unrealized в vault',
    descEn: '$49,335 × 1 day @ ~3.63% APY — unrealized in vault',
    pnlBase: +0.006, type: 'pos' as const,
  },
  {
    dateRu: '24 июл 2026', dateEn: 'Jul 24, 2026',
    nameRu: 'HY v1.1 APY: восстановление выше Prime', nameEn: 'HY v1.1 APY: recovers above prime tier',
    descRu: '3.63% → 4.40% — снова выше нашего Prime (4.42% рынок в целом вырос); весь Morpho USDC-рынок скакнул вверх',
    descEn: '3.63% → 4.40% — recovered as broad Morpho USDC market jumped up (our Prime hit 4.42%)',
    pnlBase: 0, type: 'pos' as const,
  },
  {
    dateRu: '23–24 июл 2026', dateEn: 'Jul 23–24, 2026',
    nameRu: 'Morpho Prime: yield (1 день)', nameEn: 'Morpho Prime: yield (1 day)',
    descRu: '$50 000 × 1 день @ ~4.42% APY — unrealized в vault',
    descEn: '$50,000 × 1 day @ ~4.42% APY — unrealized in vault',
    pnlBase: +0.006, type: 'pos' as const,
  },
  {
    dateRu: '23–24 июл 2026', dateEn: 'Jul 23–24, 2026',
    nameRu: 'HY v1.1: yield (1 день)', nameEn: 'HY v1.1: yield (1 day)',
    descRu: '$49 335 × 1 день @ ~4.40% APY — unrealized в vault',
    descEn: '$49,335 × 1 day @ ~4.40% APY — unrealized in vault',
    pnlBase: +0.005, type: 'pos' as const,
  },
  {
    dateRu: '27 июл 2026', dateEn: 'Jul 27, 2026',
    nameRu: 'HY v1.1 APY: третья инверсия за 2 недели', nameEn: 'HY v1.1 APY: third inversion in 2 weeks',
    descRu: '4.40% → 3.28% — самый глубокий провал (−1.08% vs Gauntlet Prime); амплитуда циклов растёт',
    descEn: '4.40% → 3.28% — deepest dip yet (−1.08% vs Gauntlet Prime); cycle amplitude increasing',
    pnlBase: 0, type: 'neg' as const,
  },
  {
    dateRu: '24–27 июл 2026', dateEn: 'Jul 24–27, 2026',
    nameRu: 'Morpho Prime: yield (3 дня)', nameEn: 'Morpho Prime: yield (3 days)',
    descRu: '$50 000 × 3 дня @ ~4.13–4.42% APY — unrealized в vault',
    descEn: '$50,000 × 3 days @ ~4.13–4.42% APY — unrealized in vault',
    pnlBase: +0.018, type: 'pos' as const,
  },
  {
    dateRu: '24–27 июл 2026', dateEn: 'Jul 24–27, 2026',
    nameRu: 'HY v1.1: yield (3 дня)', nameEn: 'HY v1.1: yield (3 days)',
    descRu: '$49 335 × 3 дня @ ~3.28–4.40% APY — unrealized в vault',
  ...
  {
    dateRu: '29 июл 2026', dateEn: 'Jul 29, 2026',
    nameRu: 'HY v1.1 APY: восстановление, спред закрылся', nameEn: 'HY v1.1 APY: recovers, spread closes',
    descRu: '3.25% → 5.37% — снова выше нашего Prime (4.42%); замечен крупный отток TVL из Prime v1 в новый Prime v2 (0% fee)',
    descEn: '3.25% → 5.37% — back above our Prime (4.42%); large TVL outflow observed from Prime v1 to new Prime v2 (0% fee)',
    pnlBase: 0, type: 'pos' as const,
  },
  {
    dateRu: '28–29 июл 2026', dateEn: 'Jul 28–29, 2026',
    nameRu: 'Morpho Prime: yield (1 день)', nameEn: 'Morpho Prime: yield (1 day)',
    descRu: '$50 000 × 1 день @ ~4.42% APY — unrealized в vault',
    descEn: '$50,000 × 1 day @ ~4.42% APY — unrealized in vault',
    pnlBase: +0.005, type: 'pos' as const,
  },
  {
    dateRu: '28–29 июл 2026', dateEn: 'Jul 28–29, 2026',
    nameRu: 'HY v1.1: yield (1 день)', nameEn: 'HY v1.1: yield (1 day)',
    descRu: '$49 335 × 1 день @ ~5.37% APY — unrealized в vault',
    descEn: '$49,335 × 1 day @ ~5.37% APY — unrealized in vault',
    pnlBase: +0.006, type: 'pos' as const,
  },
  {
    dateRu: '30 июл 2026', dateEn: 'Jul 30, 2026',
    nameRu: 'HY v1.1 APY: пятый цикл инверсии', nameEn: 'HY v1.1 APY: fifth inversion cycle',
    descRu: '5.37% → 3.33% — паттерн ежедневных качелей подтверждён (5 циклов за 2 недели), premium в среднем сохраняется',
    descEn: '5.37% → 3.33% — daily swing pattern confirmed (5 cycles in 2 weeks), average premium still holds',
    pnlBase: 0, type: 'neg' as const,
  },
  {
    dateRu: '29–30 июл 2026', dateEn: 'Jul 29–30, 2026',
    nameRu: 'Morpho Prime: yield (1 день)', nameEn: 'Morpho Prime: yield (1 day)',
    descRu: '$50 000 × 1 день @ ~4.15% APY — unrealized в vault',
    descEn: '$50,000 × 1 day @ ~4.15% APY — unrealized in vault',
    pnlBase: +0.006, type: 'pos' as const,
  },
  {
    dateRu: '29–30 июл 2026', dateEn: 'Jul 29–30, 2026',
    nameRu: 'HY v1.1: yield (1 день)', nameEn: 'HY v1.1: yield (1 day)',
    descRu: '$49 335 × 1 день @ ~3.33% APY — unrealized в vault',
  ...
  {
    dateRu: '31 июл – 4 авг 2026', dateEn: 'Jul 31 – Aug 4, 2026',
    nameRu: 'Morpho Prime v2: yield (4 дня)', nameEn: 'Morpho Prime v2: yield (4 days)',
    descRu: '$50 368 × 4 дня @ ~4.32–4.37% APY — unrealized в vault',
    descEn: '$50,368 × 4 days @ ~4.32–4.37% APY — unrealized in vault',
    pnlBase: +0.023, type: 'pos' as const,
  },
  {
    dateRu: '31 июл – 4 авг 2026', dateEn: 'Jul 31 – Aug 4, 2026',
    nameRu: 'Morpho HY v2: yield (4 дня)', nameEn: 'Morpho HY v2: yield (4 days)',
    descRu: '$49 649 × 4 дня @ ~4.77–4.88% APY (net, 5% fee) — unrealized в vault',
    descEn: '$49,649 × 4 days @ ~4.77–4.88% APY (net, 5% fee) — unrealized in vault',
    pnlBase: +0.025, type: 'pos' as const,
  },
  {
    dateRu: '4–5 авг 2026', dateEn: 'Aug 4–5, 2026',
    nameRu: 'Morpho Prime v2: yield (1 день)', nameEn: 'Morpho Prime v2: yield (1 day)',
    descRu: '$50 368 × 1 день @ ~4.67% APY — unrealized в vault',
    descEn: '$50,368 × 1 day @ ~4.67% APY — unrealized in vault',
    pnlBase: +0.007, type: 'pos' as const,
  },
  {
    dateRu: '4–5 авг 2026', dateEn: 'Aug 4–5, 2026',
    nameRu: 'Morpho HY v2: yield (1 день)', nameEn: 'Morpho HY v2: yield (1 day)',
    descRu: '$49 649 × 1 день @ ~5.54% APY (net, 5% fee) — unrealized в vault',
    descEn: '$49,649 × 1 day @ ~5.54% APY (net, 5% fee) — unrealized in vault',
    pnlBase: +0.008, type: 'pos' as const,
  },
  {
    dateRu: '7 авг 2026', dateEn: 'Aug 7, 2026',
    nameRu: 'HY v2: третий рост подряд, без качелей', nameEn: 'HY v2: third rise in a row, no swings',
    descRu: '4.88% → 5.54% → 5.84% — стабильный тренд вместо ежедневных инверсий, характерных для закрытого HY v1.1 (сейчас 4.26%)',
    descEn: '4.88% → 5.54% → 5.84% — steady trend instead of the daily inversions seen in the closed HY v1.1 (now 4.26%)',
    pnlBase: 0, type: 'pos' as const,
  },
  {
    dateRu: '5–7 авг 2026', dateEn: 'Aug 5–7, 2026',
    nameRu: 'Morpho Prime v2: yield (2 дня)', nameEn: 'Morpho Prime v2: yield (2 days)',
    descRu: '$50 368 × 2 дня @ ~4.44–4.67% APY — unrealized в vault',
    descEn: '$50,368 × 2 days @ ~4.44–4.67% APY — unrealized in vault',
    pnlBase: +0.012, type: 'pos' as const,
  },
  {
    dateRu: '5–7 авг 2026', dateEn: 'Aug 5–7, 2026',
    nameRu: 'Morpho HY v2: yield (2 дня)', nameEn: 'Morpho HY v2: yield (2 days)',
    descRu: '$49 649 × 2 дня @ ~5.54–5.84% APY (net, 5% fee) — unrealized в vault',
    descEn: '$49,649 × 2 days @ ~5.54–5.84% APY (net, 5% fee) — unrealized in vault',
    pnlBase: +0.015, type: 'pos' as const,
  },
  {
    dateRu: '7–10 авг 2026', dateEn: 'Aug 7–10, 2026',
    nameRu: 'Morpho Prime v2: yield (3 дня)', nameEn: 'Morpho Prime v2: yield (3 days)',
    descRu: '$50 368 × 3 дня @ ~4.44–4.67% APY — unrealized в vault',
    descEn: '$50,368 × 3 days @ ~4.44–4.67% APY — unrealized in vault',
    pnlBase: +0.018, type: 'pos' as const,
  },
  {
    dateRu: '7–10 авг 2026', dateEn: 'Aug 7–10, 2026',
    nameRu: 'Morpho HY v2: yield (3 дня)', nameEn: 'Morpho HY v2: yield (3 days)',
    descRu: '$49 649 × 3 дня @ ~5.35–5.84% APY (net, 5% fee) — unrealized в vault',
    descEn: '$49,649 × 3 days @ ~5.35–5.84% APY (net, 5% fee) — unrealized in vault',
    pnlBase: +0.024, type: 'pos' as const,
  },
  {
    dateRu: '12 авг 2026', dateEn: 'Aug 12, 2026',
    nameRu: 'HY v2 APY: 7.00% — максимум с входа', nameEn: 'HY v2 APY: 7.00% — highest since entry',
    descRu: '5.35% → 7.00% net (после 5% fee); спред к закрытому HY v1.1 снова в нашу пользу: +2.06%',
    descEn: '5.35% → 7.00% net (after 5% fee); spread vs the closed HY v1.1 back in our favour: +2.06%',
    pnlBase: 0, type: 'pos' as const,
  },
  {
    dateRu: '10–12 авг 2026', dateEn: 'Aug 10–12, 2026',
    nameRu: 'Morpho Prime v2: yield (2 дня)', nameEn: 'Morpho Prime v2: yield (2 days)',
    descRu: '$50 368 × 2 дня @ ~4.12–4.67% APY — unrealized в vault',
    descEn: '$50,368 × 2 days @ ~4.12–4.67% APY — unrealized in vault',
    pnlBase: +0.014, type: 'pos' as const,
  },
  {
    dateRu: '10–12 авг 2026', dateEn: 'Aug 10–12, 2026',
    nameRu: 'Morpho HY v2: yield (2 дня)', nameEn: 'Morpho HY v2: yield (2 days)',
    descRu: '$49 649 × 2 дня @ ~5.35–7.00% APY (net, 5% fee) — unrealized в vault',
  ...
  {
    dateRu: '13–14 авг 2026', dateEn: 'Aug 13–14, 2026',
    nameRu: 'Morpho Prime v2: yield (1 день)', nameEn: 'Morpho Prime v2: yield (1 day)',
    descRu: '$50 368 × 1 день @ ~4.12% APY — unrealized в vault',
    descEn: '$50,368 × 1 day @ ~4.12% APY — unrealized in vault',
    pnlBase: +0.004, type: 'pos' as const,
  },
  {
    dateRu: '13–14 авг 2026', dateEn: 'Aug 13–14, 2026',
    nameRu: 'Morpho HY v2: yield (1 день)', nameEn: 'Morpho HY v2: yield (1 day)',
    descRu: '$49 649 × 1 день @ ~5.35% APY (net, 5% fee) — 14 дней без единого действия после миграции',
    descEn: '$49,649 × 1 day @ ~5.35% APY (net, 5% fee) — 14 days with zero action since migration',
    pnlBase: +0.006, type: 'pos' as const,
  },
  {
    dateRu: '14–17 авг 2026', dateEn: 'Aug 14–17, 2026',
    nameRu: 'Morpho Prime v2: yield (3 дня)', nameEn: 'Morpho Prime v2: yield (3 days)',
    descRu: '$50 368 × 3 дня @ ~4.12–4.14% APY — unrealized в vault',
    descEn: '$50,368 × 3 days @ ~4.12–4.14% APY — unrealized in vault',
    pnlBase: +0.017, type: 'pos' as const,
  },
  {
    dateRu: '14–17 авг 2026', dateEn: 'Aug 14–17, 2026',
    nameRu: 'Morpho HY v2: yield (3 дня)', nameEn: 'Morpho HY v2: yield (3 days)',
    descRu: '$49 649 × 3 дня @ ~5.23–5.35% APY (net, 5% fee) — unrealized в vault',
    descEn: '$49,649 × 3 days @ ~5.23–5.35% APY (net, 5% fee) — unrealized in vault',
    pnlBase: +0.022, type: 'pos' as const,
  },
  {
    dateRu: '17–18 авг 2026', dateEn: 'Aug 17–18, 2026',
    nameRu: 'Morpho Prime v2: yield (1 день)', nameEn: 'Morpho Prime v2: yield (1 day)',
    descRu: '$50 368 × 1 день @ ~4.12% APY — unrealized в vault',
    descEn: '$50,368 × 1 day @ ~4.12% APY — unrealized in vault',
    pnlBase: +0.006, type: 'pos' as const,
  },
  {
    dateRu: '17–18 авг 2026', dateEn: 'Aug 17–18, 2026',
    nameRu: 'Morpho HY v2: yield (1 день)', nameEn: 'Morpho HY v2: yield (1 day)',
    descRu: '$49 649 × 1 день @ ~5.10% APY (net, 5% fee) — HY v1.1 (закрыт) просел до 3.85%, миграция подтверждена',
  ...
  {
    dateRu: '21 авг 2026', dateEn: 'Aug 21, 2026',
    nameRu: 'ETH: +33% за 3 дня', nameEn: 'ETH: +33% over 3 days',
    descRu: '$1 912 → $2 098 → $2 318 → $2 540 за ту же 0.00458 ETH — газовый буфер подорожал, DeFi-позиции не затронуты',
    descEn: '$1,912 → $2,098 → $2,318 → $2,540 for the same 0.00458 ETH — gas buffer value rose, DeFi positions unaffected',
    pnlBase: 0, type: 'open' as const,
  },
  {
    dateRu: '20–21 авг 2026', dateEn: 'Aug 20–21, 2026',
    nameRu: 'Morpho Prime v2: yield (1 день)', nameEn: 'Morpho Prime v2: yield (1 day)',
    descRu: '$50 368 × 1 день @ ~4.18% APY — unrealized в vault; TVL vault снизился ($579M → $536M), APY не пострадал',
    descEn: '$50,368 × 1 day @ ~4.18% APY — unrealized in vault; vault TVL fell ($579M → $536M), APY unaffected',
    pnlBase: +0.006, type: 'pos' as const,
  },
  {
    dateRu: '20–21 авг 2026', dateEn: 'Aug 20–21, 2026',
    nameRu: 'Morpho HY v2: yield (1 день)', nameEn: 'Morpho HY v2: yield (1 day)',
    descRu: '$49 649 × 1 день @ ~4.92% APY (net, 5% fee) — unrealized в vault',
  ...
  {
    dateRu: '25 авг 2026', dateEn: 'Aug 25, 2026',
    nameRu: 'Prime v2: отток TVL остановился', nameEn: 'Prime v2: TVL outflow stops',
    descRu: '$443M → $441M — плато после недели снижения; ложная тревога снята. 25 дней с миграции — обе позиции стабильны',
    descEn: '$443M → $441M — plateau after a week of decline; false alarm cleared. 25 days since migration — both positions stable',
    pnlBase: 0, type: 'pos' as const,
  },
  {
    dateRu: '24–25 авг 2026', dateEn: 'Aug 24–25, 2026',
    nameRu: 'Morpho Prime v2: yield (1 день)', nameEn: 'Morpho Prime v2: yield (1 day)',
    descRu: '$50 368 × 1 день @ ~4.42% APY — unrealized в vault',
    descEn: '$50,368 × 1 day @ ~4.42% APY — unrealized in vault',
    pnlBase: +0.007, type: 'pos' as const,
  },
  {
    dateRu: '24–25 авг 2026', dateEn: 'Aug 24–25, 2026',
    nameRu: 'Morpho HY v2: yield (1 день)', nameEn: 'Morpho HY v2: yield (1 day)',
    descRu: '$49 649 × 1 день @ ~5.20% APY (net, 5% fee) — unrealized в vault',
    descEn: '$49,649 × 1 day @ ~5.20% APY (net, 5% fee) — unrealized in vault',
    pnlBase: +0.008, type: 'pos' as const,
  },
  {
    dateRu: '30 авг 2026', dateEn: 'Aug 30, 2026',
    nameRu: 'Месяц с миграции — без единого вмешательства', nameEn: 'One month since migration — zero intervention',
    descRu: 'HY v2 TVL продолжает расти ($34.6M → $36.8M); обе позиции стабильны или растут по APY весь месяц',
    descEn: 'HY v2 TVL keeps growing ($34.6M → $36.8M); both positions stable or trending up in APY all month',
    pnlBase: 0, type: 'open' as const,
  },
  {
    dateRu: '25–30 авг 2026', dateEn: 'Aug 25–30, 2026',
    nameRu: 'Morpho Prime v2: yield (5 дней)', nameEn: 'Morpho Prime v2: yield (5 days)',
    descRu: '$50 368 × 5 дней @ ~4.42% APY — unrealized в vault',
    descEn: '$50,368 × 5 days @ ~4.42% APY — unrealized in vault',
    pnlBase: +0.029, type: 'pos' as const,
  },
  {
    dateRu: '25–30 авг 2026', dateEn: 'Aug 25–30, 2026',
    nameRu: 'Morpho HY v2: yield (5 дней)', nameEn: 'Morpho HY v2: yield (5 days)',
    descRu: '$49 649 × 5 дней @ ~5.20–5.22% APY (net, 5% fee) — unrealized в vault',
    descEn: '$49,649 × 5 days @ ~5.20–5.22% APY (net, 5% fee) — unrealized in vault',
    pnlBase: +0.033, type: 'pos' as const,
  },
  {
    dateRu: '30 авг – 2 сен 2026', dateEn: 'Aug 30 – Sep 2, 2026',
    nameRu: 'Morpho Prime v2: yield (3 дня)', nameEn: 'Morpho Prime v2: yield (3 days)',
    descRu: '$50 368 × 3 дня @ ~4.26–4.42% APY — unrealized в vault',
    descEn: '$50,368 × 3 days @ ~4.26–4.42% APY — unrealized in vault',
    pnlBase: +0.017, type: 'pos' as const,
  },
  {
    dateRu: '30 авг – 2 сен 2026', dateEn: 'Aug 30 – Sep 2, 2026',
    nameRu: 'Morpho HY v2: yield (3 дня)', nameEn: 'Morpho HY v2: yield (3 days)',
    descRu: '$49 649 × 3 дня @ ~5.02–5.22% APY (net, 5% fee) — unrealized в vault',
    descEn: '$49,649 × 3 days @ ~5.02–5.22% APY (net, 5% fee) — unrealized in vault',
    pnlBase: +0.020, type: 'pos' as const,
  },
  {
    dateRu: '2–9 сен 2026', dateEn: 'Sep 2–9, 2026',
    nameRu: 'Morpho Prime v2: yield (7 дней)', nameEn: 'Morpho Prime v2: yield (7 days)',
    descRu: '$50 368 × 7 дней @ ~4.15–4.26% APY — unrealized в vault',
    descEn: '$50,368 × 7 days @ ~4.15–4.26% APY — unrealized in vault',
    pnlBase: +0.043, type: 'pos' as const,
  },
  {
    dateRu: '2–9 сен 2026', dateEn: 'Sep 2–9, 2026',
    nameRu: 'Morpho HY v2: yield (7 дней)', nameEn: 'Morpho HY v2: yield (7 days)',
    descRu: '$49 649 × 7 дней @ ~4.79–5.02% APY (net, 5% fee) — unrealized в vault',
    descEn: '$49,649 × 7 days @ ~4.79–5.02% APY (net, 5% fee) — unrealized in vault',
    pnlBase: +0.049, type: 'pos' as const,
  },
  {
    dateRu: '9–10 сен 2026', dateEn: 'Sep 9–10, 2026',
    nameRu: 'Morpho Prime v2: yield (1 день)', nameEn: 'Morpho Prime v2: yield (1 day)',
    descRu: '$50 368 × 1 день @ ~4.26% APY — unrealized в vault',
    descEn: '$50,368 × 1 day @ ~4.26% APY — unrealized in vault',
    pnlBase: +0.005, type: 'pos' as const,
  },
  {
    dateRu: '9–10 сен 2026', dateEn: 'Sep 9–10, 2026',
